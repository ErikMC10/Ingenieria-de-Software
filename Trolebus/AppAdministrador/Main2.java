...
public class Main2 extends AppCompatActivity {
    ...
    public void User(final String correo)
    {
        ...
        mDatabase.child("Usuarios").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                //Toast.makeText(Main2.this, "user:"+user, Toast.LENGTH_SHORT).show();
                final Intent intent = new Intent(Main2.this, BackgroundService.class);
                intent.putExtra("correoo",correo);
